  ...
  return (
    <Wrap>
      <OrbitsWrap>
        ...
        <DeviantOrbitLegend text="TWITTER" direction="right" planetId={5} setState={setState} />
      </OrbitsWrap>
      ...
      <Orbit zindex={50} size={174} color="#97ec04">
        <OrbitSpin className={cn({ "pause-animation": pauseSpinForOrbitId === 1 })} speed={7}>
          <Planet
            ...
            glow="#f1f8fb"
            setState={setState}
            onClick={() => window.open("https://www.linkedin.com/in/m-l-abhinav-1906743b8/")}
      ...
      <Orbit zindex={49} size={308} color="#00ee5a">
        <OrbitSpin className={cn({ "pause-animation": pauseSpinForOrbitId === 2 })} speed={18}>
          <Planet
            ...
            state={state}
            setState={setState}
            onClick={() => window.open("https://github.com/astro-abhi")}
            planetsRefs={planetsRefs}
          />
        </OrbitSpin>
      </Orbit>
      ...
      <Orbit zindex={47} size={650} color="#009b5f">
        <OrbitSpin className={cn({ "pause-animation": pauseSpinForOrbitId === 4 })} speed={28}>
          ...
          <Planet
            ...
            setState={setState}
            onClick={() => {
              window.open("https://x.com/l_abhinav19093");
            }}
            style={{
              top: "466px",
              left: "44px",
